...
* Copying from old practice set, mini project, or quiz solutions is plagiarism;
...
- If you commit an academic integrity violation on a practice set or mini project, you will be given a zero for that entire assignment, **which will not be dropped under any circumstances**.
